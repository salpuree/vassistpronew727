...
const Footer = () => {
  ...
  return (
    <footer className="bg-slate-900 border-t border-border/20">
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social, index) => (
                  <a
                    ...
                    className="w-10 h-10 bg-slate-800 rounded-full flex items-center justify-center text-slate-400 hover:bg-slate-700 hover:text-white transition-all duration-300 hover:scale-110"
                  >
                    <social.icon />
                  </a>
                ))}
