    ...
    <section id="testimonials" className="py-24 bg-luxury-gradient">
      <div className="container mx-auto px-4">
              ...
              {testimonials.map((testimonial, index) => (
                <div key={index} className="w-full flex-shrink-0 px-4">
                  <div className="group cursor-default">
                    <div className={`relative bg-card/60 backdrop-blur-xl border border-border/30 rounded-3xl p-8 hover:border-primary/30 transition-all duration-500 overflow-hidden hover:shadow-2xl hover:shadow-primary/20`}>
        ...
        <div className="text-center mt-16">
          <div className="relative bg-white border border-border/50 rounded-3xl p-8 w-full shadow-lg hover:shadow-2xl hover:shadow-primary/20 transition-all duration-500 hover:scale-[1.02] hover:border-primary/40 group cursor-pointer overflow-hidden">
