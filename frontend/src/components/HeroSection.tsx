...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-between overflow-hidden pt-20 pb-48"> {/* added pb-48 */}
      ...
      <div className="relative z-10 py-8 px-4 bg-gradient-to-t from-background/80 to-transparent animate-fade-in mt-4" style={{ animationDelay: "0.8s" }}> {/* changed from absolute to relative, added mt-10 */}
